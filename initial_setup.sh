...
incus launch ubuntu/$VERSION base
...
firewall-cmd --permanent --direct --add-rule ipv4 filter INPUT 0 -i incusbr0 -s 0.0.0.0/24 -m comment --comment "generated by firewalld for Incus" -j ACCEPT
firewall-cmd --permanent --direct --add-rule ipv4 filter OUTPUT 0 -o incusbr0 -d 0.0.0.0/24 -m comment --comment "generated by firewalld for Incus" -j ACCEPT
firewall-cmd --permanent --direct --add-rule ipv4 filter FORWARD 0 -i incusbr0 -s 0.0.0.0/24 -m comment --comment "generated by firewalld for Incus" -j ACCEPT
firewall-cmd --permanent --direct --add-rule ipv4 nat POSTROUTING 0 -s 0.0.0.0/24 ! -d 0.0.0.0/24 -m comment --comment "generated by firewalld for Incus" -j MASQUERADE
firewall-cmd --reload
incus stop base
incus delete base
